...
import 'package:skate_shop/screens/skateScreen.dart';
  ...
  _skateSelector(int index){
    return AnimatedBuilder(
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(context,MaterialPageRoute(builder: (_) => SkateScreen(skate: skates[index])));
        },
        child: Stack(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(skates[_selectedPage].description ,
                    style: TextStyle(
                      fontSize: 16,
